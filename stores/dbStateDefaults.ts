...
export const defaultSectionVisibility: Record<SectionKey, boolean> = { metricsCards: true, allTrades: true, profitTrades: true, losingTrades: true, winLossComparison: true, riskRatios: true, dayStatistics: false }
export const hiddenChartVisibility: Record<string, boolean> = { pnlBar: false, cumulatedPnl: false, appt: false, winrate: false, 'timeSeries_defaultPnlByTrade': false, 'timeSeries_defaultCumulatedPnl': false, 'timeSeries_defaultAppt': false, 'timeSeries_defaultWinrate': false, 'breakdownHeatmap_defaultHourDay': false, 'breakdownBarVertical_defaultWinrateByHour': false, 'breakdownBarVertical_defaultPnlByDayOfWeek': false }
export const hiddenSectionVisibility: Record<SectionKey, boolean> = { metricsCards: false, allTrades: false, profitTrades: false, losingTrades: false, winLossComparison: false, riskRatios: false, dayStatistics: false }
